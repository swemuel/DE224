...
class Database implements IDatabase
{
    ...
    public function query ($sql) {
		...
		if (!$result) {
			throw new DatabaseException($this->sqlError('query'));
		}
		$rows=array();
	...
	public function queryPrepared($paramaterisedSQL,$fields) {
		throw new DatabaseException("Not yet implemented");
	}
	
    public function executePrepared($paramaterisedSQL,$fields) {
		throw new DatabaseException("Not yet implemented");
	}
